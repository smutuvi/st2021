...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask, input_mask, token_type_ids, label_id, true = -1,
                 e1_mask = None, e2_mask = None, keys=None, segment_ids=None, valid_ids=None, label_mask=None):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
